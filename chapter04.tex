...
Una \key{estructura} de datos es una manera de
...
más importantes en la \key{STL (Standard Template Library)}
de C++.
...
Un \key{dynamic array} es un arreglo cuyo 
tamaño puede ser cambiado en tiempo de ejecución.
El arreglo dinámico más popular en C++ es
la estructura \texttt{vector},
que puede ser usada casi como un arreglo ordinario.
...
Después de esto el acceso a los elementos puede hacerse como en un arreglo normal:
